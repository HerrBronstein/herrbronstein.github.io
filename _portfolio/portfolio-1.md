...
share: false
---
During this project with [Adrien Martinelli](https://github.com/SequoiaCode), we studied the Benjamin-Bona-Mahony (BBM) equation, describing long wave of small amplitude in dispersive medium (solitons for instance). The equation writes : $\partial_t u + \partial_x u + u \partial_x u - \partial_{txx}^3 u = 0$
